"""
Открытие шлагбаума иммитировано в функции main при сравнение 
расспознанного значения с имеющимися в 
списке разрешенных номеров.
"""
import cv2
import pytesseract
from List_of_vehicle_numbers import ALLOWED_PLATE_NUMBERS
...
def main():
    cap = cv2.VideoCapture(r'C:\Dev\detect_car_number\cars\5.mp4')
    ...
    while True:
        ...
        plates = plate_cascade.detectMultiScale(
            ...
            minNeighbors=8,
            minSize=(30, 30))
        #allowed_plate_numbers = ['A695KA799', 'C065MK78', 'A888AA00', 'H778EM799', 'K425CE82', 'H961BB82']
